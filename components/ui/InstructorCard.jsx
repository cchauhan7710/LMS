...
const InstructorCard = ({ name, title, bio, avatar, navigate }) => {
    return (
        <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 p-8 text-center flex flex-col items-center">
            ...
            <button 
                ...
                className="flex items-center space-x-2 text-primary-600 dark:text-primary-400 font-semibold py-2 px-4 rounded-lg hover:bg-primary-50 dark:hover:bg-primary-900/40 transition duration-300 group"
            >
